...
import { calculateSummaries, calculateMixedPlasticSummaries } from "@/app/utils/calculateSummaries";
...
const MixedPlasticFootprintMultiStackedBar = () => {
...
export default MixedPlasticFootprintMultiStackedBar;
