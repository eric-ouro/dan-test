...
const DashboardContent = () => {
  ...
  return (
    <div>
        <div className="responsive-padding border-b border-b-foreground/20 bg-background sticky pt-[30px] pb-[15px] top-0 z-20 flex flex-col justify-start items-left  gap-4">
