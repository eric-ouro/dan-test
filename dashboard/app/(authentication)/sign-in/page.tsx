  ...
  return (
    <>
      <div className="flex flex-col z-20 min-w-64 max-w-64 mx-auto p-6 bg-[#1c1c1c] dark:bg-[#313131FF] rounded-lg shadow-lg sans">
        <form className="z-10">
          <h1 className="text-4xl font-medium mb-2 text-background dark:text-foreground tracking-[-0.07em]">Sign in</h1>
          <p className="text-sm text-background dark:text-foreground">
            Don't have an account?{" "}
            <Link className="text-background dark:text-foreground font-medium underline" href="/sign-up">
              Sign up
            </Link>
          </p>
          <div className="flex flex-col gap-1 [&>input]:mb-3 mt-6">
            ...
            <Input
              ...
              minLength={6}
              required
              className="dark:bg-foreground/10 dark:text-background"
            />
